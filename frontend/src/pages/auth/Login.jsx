    ...
    return (
        <div className="mt-10 auth-page flex flex-col justify-center items-center min-h-screen bg-gray-100 mb-20">
            <div className="flex flex-col">
                <h2 className="h2 text-2xl font-bold mb-6 text-center">
                    HouRenShuu
                </h2>
                <h2 className="h2 text-2xl font-bold mb-6 text-center">
                    ログイン
            ...
            <div
                className="flex flex-col gap-4 auth-form w-[450px] p-8 rounded-lg shadow-lg"
            ...
            >
                ...
                <form onSubmit={submitHandler} className="space-y-4">
                    ...
                    <div className="flex items-center">
                        ...
                        <label
                            htmlFor="remember"
                            className="ml-2 pb-1 text-sm text-gray-600"
                        >
                            ログイン状態を維持
                        </label>
                    </div>
